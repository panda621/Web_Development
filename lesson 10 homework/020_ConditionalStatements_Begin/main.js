window.onload = function() {
    ...
    //     if ( question1.value == "" ) {
    //         alert("Please enter a values for question 1")
    //     }
    // } )
    // Method 2:
    ...
    question3.onblur = function() {
        if (question3.value == "") {
            alert("Please enter a value for question3");
        } 
    }

    question4.onblur = function() {
        if (question4.value == ""){
            alert("Please enter a value for question4");
        }
    }

    question5.onblur = function() {
        if (question5.value == ""){
            alert("Please enter a value for question5");
        }
    }

    question6.onblur = function() {
        if (question6.value == ""){
            alert("Please enter a value for question6");
        }
    }

    question7.onblur = function() {
        if (question7.value == ""){
            alert("Please enter a value for question7");
        }
    }

    question8.onblur = function() {
        if (question8.value == ""){
            alert("Please enter a value for question8");
        }
    }
    question9.onblur = function() {
        if (question9.value == ""){
            alert("Please enter a value for question9");
        } 
    }
    question10.onblur = function() {
        if (question10.value == ""){
            alert("Please enter a value for question10");
        }
    }
    ...
    question1.onchange = function() {
        ...
        // else if the question1.value is the third choice
             ...
             *      Reference: https://www.w3schools.com/jsref/jsref_operators.asp
             */
            info.innerHTML += "=> Milky Way Galaxy is the name of our galaxy in the constellation of Sagittarius. It is a spiral galaxy with a diameter of 100,000 light-years. It is located at a distance of 30,000 light-years from Earth.";
        } 
